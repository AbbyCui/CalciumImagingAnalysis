...
for i in range(1,2):
    ...
    ISIstats.append(getISIstat(True,st,amp))

# np.savetxt(pathToOutputData + prefix + "ISIstats.csv", ISIstats, delimiter=',', comments='', fmt='%s')
